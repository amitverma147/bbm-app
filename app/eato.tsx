...
export default function EatoPage() {
    ...
    return (
        <View className="flex-1 bg-white">
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', alignItems: 'center', padding: 24 }}>
                <View className="bg-emerald-50 border border-emerald-100 p-8 rounded-full mb-6 shadow-sm">
                    <Ionicons name="restaurant" size={72} color="#059669" />
                </View>
