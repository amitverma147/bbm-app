    ...
    return (
        <View className="py-6 bg-white">
            <View className="px-4 mb-4">
                ...
                <Text className="text-gray-500 text-sm">Discover products from these top brands</Text>
            </View>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 16 }}>
                {brands.map((brand) => (
                    <TouchableOpacity
                        ...
                        className="mr-3 w-[100px] h-[120px] bg-white rounded-3xl border border-gray-100 items-center justify-center p-2 shadow-sm"
                    >
                        {brand.image ? (
                            <Image
                            ...
                            <Text className="font-bold text-gray-400 text-center">{brand.name}</Text>
                        )}
                    </TouchableOpacity>
                ))}
            </ScrollView>
