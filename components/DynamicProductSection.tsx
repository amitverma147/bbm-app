...
const DynamicProductSection = (props: DynamicProductSectionProps) => {
    ...
    const loadData = async () => {
        ...
        console.log(`DynamicProductSection [${props.sectionName || endpoint}] items:`, productsList.length);
    ...
    return (
        <ProductSection
            title={section?.section_name || section?.component_name || props.sectionName || "Section"}
            data={products}
        />
    )
}
