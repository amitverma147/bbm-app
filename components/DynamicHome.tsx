...
const COMPONENT_MAP: any = {
    ...
    'DynamicMegaSale': (props: any) => <DynamicMegaSale {...props} products={props.data?.products} />,
    'SmallPromoCards': SmallPromoCards,
    'PromoBanner': PromoBanner,
    'ShopByStore': ShopByStore,

    // Complex Sections
    'DiscountCorner': () => <DualCategorySection sectionLeftKey="discount_corner_left" sectionRightKey="discount_corner_right" />,
    'DualDeals': () => <DualCategorySection sectionLeftKey="dual_deals_left" sectionRightKey="dual_deals_right" />,
    ...
    'BigBestMartDeals': (props: any) => <DynamicProductSection {...props} endpoint="/productsroute/super-saver" />,
    'QuickPicks': (props: any) => <DynamicProductSection {...props} endpoint="/productsroute/super-saver?limit=50" />,
    'DailyDeals': DailyDeals, // Updated Mapping
    'EverydayEssentials': (props: any) => <DynamicProductSection {...props} endpoint="/productsroute/top-products" />,
...
const DynamicHome = ({ ListHeaderComponent }: { ListHeaderComponent?: React.ReactElement }) => {
    ...
    const loadSections = async () => {
        try {
            ...
            let updatedSections = data.filter((s: any) => s.component_name !== 'QuickAccess' && s.component_name !== 'PriceZone');
            ...
            updatedSections.sort((a: any, b: any) => (a.display_order || 99) - (b.display_order || 99));
    ...
    const keyExtractor = React.useCallback((item: any) => item.id?.toString() || item.section_key, []);
